...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://tiffincrm.com/assets/img/icons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="https://tiffincrm.com/assets/img/icons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="https://tiffincrm.com/assets/img/icons/favicon-16x16.png" />
    <link rel="manifest" href="https://tiffincrm.com/assets/img/icons/site.webmanifest" />
    <link rel="mask-icon" href="https://tiffincrm.com/assets/img/icons/safari-pinned-tab.svg" color="#1205a3" />
    <link rel="shortcut icon" href="https://tiffincrm.com/assets/img/icons/favicon.ico" />
    <meta name="msapplication-TileColor" content="#da532c" />
    <meta name="msapplication-config" content="https://tiffincrm.com/assets/img/icons/browserconfig.xml" />
    <meta name="theme-color" content="#5546af" />
    <link rel="stylesheet" href="https://tiffincrm.com/assets/css/base.css?0.0.7" />
    <link rel="stylesheet" href="https://tiffincrm.com/assets/css/style.css?1711849125" />
...
<body>
        ...
        <div class="container">
            <div class="navbar_container r-flex ali-c jut-sb">
                <a href="/" class="logo r-flex ali-c jut-c">
                    <img src="https://tiffincrm.com/assets/img/logo2.svg" alt="TiffinCRM logo" />
                </a>
    ...
    <main>
            ...
            <div class="container">
                <div class="serice_hero_container r-flex ali-c jut-sb">
                    <div class="service_left_side_cont">
                        <h1 class="color_hero_heading" style="text-align: center;">
                            Tiffin Service Management CRM App
                        </h1>
                        <div class="service_hero_main_heading" style="text-align: center;">
                            Simplifying Tiffin Services
                        </div>
                        <p class="service_help_text" style="text-align: center;">
                            You'll love the way we done it for you! 😉

                        </p>
                        <div class="hero_tips_points_box c-flex gap-2" style="align-items: center;">
                            <div class="hero_tip_box r-flex ali-c gap-15">
                                <div class="tip_line_img">
                                    <img src="https://tiffincrm.com/assets/img/check-mark.svg" alt="check mark" />
                                </div>
                        ...
                        <div class="left_side_btn_box r-flex ali-c gap-1">
                            <a href="/download-app.php?utm_source=hero_section"
                                class="play_stor_link r-flex ali-c gap-1">
                                <div class="play_stor_icon_box">
                                    <img src="https://tiffincrm.com/assets/img/paly-stor-icon.svg"
                                        alt="play stor icon" />
                                </div>
                                <span>Use in Android Phone</span>
                            </a>
                            <a target="_blank" href="https://bit.ly/msg-tiffin-crm"
                    ...
                    <div class="service_right_side_cont">
                        <div onclick="vdoPopUp()" class="hero_service_vdo_container">
                            <img src="https://tiffincrm.com/assets/img/thumbnail2.jpg" />
                        </div>
                        <div class="video_pop_box">
                            <div class="vdo_container">
                                <div onclick="vdoPopUp()" class="vdo_close_btn r-flex ali-c jut-c">
                                    <img src="https://tiffincrm.com/assets/img/close.svg" alt="crose icon" />
                                </div>
                                <div class="vdo_pop_box r-flex ali-c jut-c">
                                    <img src="https://tiffincrm.com/assets/img/thumbnail2.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="help_steps_section">
                    ...
                    <div class="steps_items_container c-flex gap-3">
                        <div class="steps_item_box r-flex ali-s jut-sb">
                            <div class="we_show_heading_box">
                                ...
                                <p class="expand_item_des">
                                    We give you list of how much and which food to prepare for breakfast, lunch, dinner
                                    separately and
                                    collectively as well. You can change the date and look the details of food to
                                    prepare in upcoming days
                                    to plan the raw material and buy that accordingly.

                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                                    <div class="step_check_img_box r-flex ali-c jut-c">
                                        <img src="https://tiffincrm.com/assets/img/down-arrow.svg?v1"
                                            alt="down arrow icon" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="steps_item_box r-flex ali-s jut-sb">
                            <div class="we_show_heading_box">
                                ...
                                <p class="expand_item_des">
                                    Same as you see details of upcoming days you can check what items to prepare with
                                    their quantity at
                                    home screen. it will by default listed as per the meal schedule but you can also
                                    play with timing and
                                    do better planing to prepare food for particular day. After preparing the Food you
                                    can go through the
                                    order wise details and pack the meals for your customers.
                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                                    <div class="step_check_img_box r-flex ali-c jut-c">
                        ...
                        <div class="steps_item_box r-flex ali-s jut-sb ">
                            <div class="we_show_heading_box">
                                ...
                                <p class="steps_items_desc">
                                    You can deliver yourself or invite delivery boy to download the app deliver
                                    accordingly. They will
                                    access to deliveries only.
                                </p>
                                <p class="expand_item_des">
                                    We have built specific screens for delivery boy which is optimized for their
                                    purpose. Admin can also
                                    view those screens and deliver themselves as well.
                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                                    <div class="step_check_img_box r-flex ali-c jut-c">
                        ...
                        <div class="steps_item_box r-flex ali-s jut-sb ">
                            <div class="we_show_heading_box">
                                ...
                                <p class="expand_item_des">
                                    You can see all the data including monthly bills, transactions, deliveris reports
                                    and your daily
                                    revenues, expenses, profits. Every data about your tiffin service business in one
                                    app.
                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                        ...
                        <div class="steps_item_box r-flex ali-s jut-sb ">
                            <div class="we_show_heading_box">
                                ...
                                <p class="expand_item_des">
                                    You can share the imeals.in link with customers and they can login with their number
                                    and see their
                                    reports, transaction, upcoming deliveries, meals plans, pause delivery option, Your
                                    Upi Handle, Your
                                    Whatsapp number. They will get limited access to do actions.
                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                                    <div class="step_check_img_box r-flex ali-c jut-c">
            ...
            >
              ...
              <img src="https://tiffincrm.com/assets/img/collapse.svg" alt="down-arrow icon" />
            </div> -->
                </div>
            </div>
        </section>
                    ...
                    <div class="cakes_box r-flex ali-c jut-sb">
                        <div class="cakes_itm r-flex ali-c gap-2">
                            <div class="cake_item_img r-flex ali-c jut-c">
                                <img src="https://tiffincrm.com/assets/img/cloude.svg" alt="Cloud" />
                            </div>
                            <span>Fully on Cloud </span>
                        </div>
                        <div class="cakes_itm r-flex ali-c gap-2">
                            <div class="cake_item_img r-flex ali-c jut-c">
                                <img src="https://tiffincrm.com/assets/img/wi-fi.svg" alt="Cloud" />
                            </div>
                            <span>Offline Access</span>
                        </div>
                        <div class="cakes_itm r-flex ali-c gap-2">
                            <div class="cake_item_img r-flex ali-c jut-c">
                                <img src="https://tiffincrm.com/assets/img/esy-uses.svg" alt="Cloud" />
                            </div>
            ...
            <div class="container">
                <div class="help_steps_container">
                    ...
                    <div class="steps_items_container active c-flex gap-3">
                        <div class="steps_item_box r-flex ali-s jut-sb" style="background-color: #ffffff;">
                            <div class="we_show_heading_box">
                                ...
                                <p class="expand_item_des">
                                    on the home screen of TiffinCrm you will find a powerfull button "Start Preparation"
                                    which will create
                                    order for all the customers who has active account With Active Meal. No further
                                    action need to be
                                    taken incase if you don’t want to cancel any delivery.
                                </p>
                                <div class="step_check_btn_box r-flex ali-c gap-05">
                                    <span>Check How</span>
                                    <div class="step_check_img_box r-flex ali-c jut-c">
                        ...
                        <div class="left_side_pricing_box">
                            <div class="top_pric_itme_heading_box r-flex ali-c gap-2">
                                <div class="item_heading_img_box r-flex ali-c jut-c">
                                    <img src="https://tiffincrm.com/assets/img/payment-feature.svg" alt="" />
                                </div>
                ...
                <div class="faq-section">
                    ...
                    <div class="faqs r-flex jut-sb" itemscope itemtype="https://schema.org/FAQPage">
                        <div class="faq-container-box">
                            <div class="container-faq" itemprop="mainEntity" itemscope
                                itemtype="https://schema.org/Question">
                                <h2 class="question active" itemprop="name">
                                    1. What is TiffinCrm and What’s it use?
                                </h2>
                                <div class="answercont" itemprop="acceptedAnswer" itemscope
                            ...
                            <div class="container-faq" itemprop="mainEntity" itemscope
                                itemtype="https://schema.org/Question">
                                <h2 class="question" itemprop="name">3. Is TiffinCrm easy to use?</h3>
                                    <div class="answercont" itemprop="acceptedAnswer" itemscope
                                        itemtype="https://schema.org/Answer">
                                        <p class="answer" itemprop="text">
                            ...
                            <div class="container-faq" itemprop="mainEntity" itemscope
                                itemtype="https://schema.org/Question">
                                <h2 class="question" itemprop="name">11. How can customers access imeals.in?</h3>
                                    <div class="answercont" itemprop="acceptedAnswer" itemscope
                                        itemtype="https://schema.org/Answer">
                                        <p class="answer" itemprop="text">
                            ...
                            <div class="container-faq" style="border-bottom: none" itemprop="mainEntity" itemscope
                                itemtype="https://schema.org/Question">
                                <h2 class="question" itemprop="name">
                ...
                <div class="container">
                    <div class="footer_contaier r-flex ali-c jut-sb">
                        <div class="footer_logo">
                            <a href="">
                                <img src="https://tiffincrm.com/assets/img/logo2.svg"
                                    alt="Tiffin Service Business Management App TiffinCRM Logo" /></a>
                        </div>
                        <div class="footer_copyright">
                            Copyright © 2024 TiffinCRM | <a href="privacy-policy.php">Privacy</a> | <a
                                href="terms-of-use.php">Terms</a>
                        </div>
                    </div>
                </div>
            </section>
        </footer>
        <script src="https://tiffincrm.com/assets/script.js"></script>
    </main>
    <script type="application/ld+json">
            ...
            "image": [
        "https://tiffincrm.com/assets/img/icons/android-chrome-512x512.png"
       ],
            "brand": {
            "@type": "Organization",
            "name": "TiffinCrm"
