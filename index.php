          ...
          <div class="service_right_side_cont">
            ...
            <div class="video_pop_box">
              <div class="vdo_container">
                ...
                <iframe width="100%" src="https://www.youtube.com/embed/J3OwLp3t6bA?si=Y7hdj9y_ypg-nkeh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <div class="steps_items_container c-flex gap-3">
            <div class="steps_item_box r-flex ali-s jut-sb">
              <div class="we_show_heading_box">
                ...
                <p class="expand_item_des">
                  We give you list of how much and which food to prepare for breakfast, lunch, dinner separately and
                  collectively as well. You can change the date and look the details of food to prepare in upcoming days
            ...
            <div class="steps_item_box r-flex ali-s jut-sb">
              <div class="we_show_heading_box">
                ...
                <p class="expand_item_des">
                  Same as you see details of upcoming days you can check what items to prepare with their quantity at
                  home screen. it will by default listed as per the meal schedule but you can also play with timing and
                  do better planing to prepare food for particular day. After preparing the Food you can go through the
            ...
            <div class="steps_item_box r-flex ali-s jut-sb ">
              <div class="we_show_heading_box">
                ...
                <p class="steps_items_desc">
                  You can deliver yourself or invite delivery boy to download the app deliver accordingly. They will
                  access to deliveries only.
                </p>
                <p class="expand_item_des">
                  We have built specific screens for delivery boy which is optimized for their purpose. Admin can also
            ...
            <div class="steps_item_box r-flex ali-s jut-sb ">
              <div class="we_show_heading_box">
                ...
                <p class="expand_item_des">
                  You can see all the data including monthly bills, transactions, deliveris reports and your daily
                  revenues, expenses, profits. Every data about your tiffin service business in one app.
                </p>
                <div class="step_check_btn_box r-flex ali-c gap-05">
                  <span>Check How</span>
                  <div class="step_check_img_box r-flex ali-c jut-c">
            ...
            <div class="steps_item_box r-flex ali-s jut-sb ">
              <div class="we_show_heading_box">
                ...
                <p class="expand_item_des">
                  You can share the imeals.in link with customers and they can login with their number and see their
                  reports, transaction, upcoming deliveries, meals plans, pause delivery option, Your Upi Handle, Your
          ...
          <div class="steps_items_container active c-flex gap-3">
            <div class="steps_item_box r-flex ali-s jut-sb" style="background-color: #ffffff;">
              <div class="we_show_heading_box">
                ...
                <p class="expand_item_des">
                  on the home screen of TiffinCrm you will find a powerfull button "Start Preparation" which will create
                  order for all the customers who has active account With Active Meal. No further action need to be
